        ...
        child: ListView(
          ...
          children: [
            DropdownButtonFormField<int>(
              ...
              items: List.generate(10, (index) => index + 1).map((e) => DropdownMenuItem(value: e, child: Text("$e분위"))).toList(),
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(labelText: '현재 소득 (단위: 만원)'),
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(labelText: '가족 인원 수'),
              keyboardType: TextInputType.number,
              validator: (value) => value!.isEmpty ? '필수 항목입니다.' : null,
            ),
            const SizedBox(height: 16),
            TextFormField(
              ...
              decoration: const InputDecoration(labelText: '자녀 수'),
              keyboardType: TextInputType.number,
              validator: (value) => value!.isEmpty ? '필수 항목입니다.' : null,
            ),
            const SizedBox(height: 16),
            const Text("기혼 여부", style: TextStyle(fontSize: 16)),
            Row(children: [Expanded(child: RadioListTile<bool>(title: const Text('기혼'), value: true, groupValue: _isMarried, onChanged: (value) => setState(() => _isMarried = value))), Expanded(child: RadioListTile<bool>(title: const Text('미혼'), value: false, groupValue: _isMarried, onChanged: (value) => setState(() => _isMarried = value)))]),
            const SizedBox(height: 16),
            TextFormField(
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(labelText: '사용가능한 예산 (단위: 만원)'),
              keyboardType: TextInputType.number,
              validator: (value) => value!.isEmpty ? '필수 항목입니다.' : null,
            ),
            const SizedBox(height: 16),
            TextFormField(
              ...
              decoration: const InputDecoration(labelText: '학교/직장 위치'),
              validator: (value) => value!.isEmpty ? '필수 항목입니다.' : null,
            ),
            ...
            ElevatedButton(
              ...
              child: _isLoading ? const CircularProgressIndicator() : const Text('진단 결과 보기', style: TextStyle(fontSize: 16)),
            ),
          ],
        ),
      ),
